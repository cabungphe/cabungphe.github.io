...
date: 2026-03-01 22:30:00 +0700
categories: [CTF]
tags: [CTF, RE]
---

![EHAX CTF 2026 Banner](./img/ehax%20ctf%202026.jpg)
...
![Kiểm tra thông tin file](./RE/i%20guess%20bro/img/check_file.png)
...
- **Lõi 3 lớp (3-Stage Check):** Để lấy được chữ "Correct!", input phải lọt qua 3 khe cửa. Cả 3 hàm đều kiểm tra cùng 1 chuỗi input:
  - Cửa 2: Một mớ hỗn độn các phương trình toán học và chia lấy dư (Z3 Solver).
    ![Cua2](./RE/i%20guess%20bro/img/cua2.png)
  - Cửa 3: Một hàm băm Hash một chiều vô phương cứu chữa.
    ![Cua3](./RE/i%20guess%20bro/img/cua3.png)
  - Cửa 1: Jack-pot! (Thuật toán đối xứng).
    ![Cua1](./RE/i%20guess%20bro/img/cua1.png)
...
![flag](./RE/i%20guess%20bro/img/flag.png)
